    ...
    <div className="relative z-10 border min-h-[30rem] w-[20rem] sm:min-w-[26rem] rounded-xl bg-white shadow-md shadow-gray-500 py-20 px-14 bg-opacity-40 backdrop-blur-[1px]">
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="flex flex-col gap-2">
          <div className="flex flex-col gap-1">
            ...
            <Controller
              ...
              render={({ field }) => (
                <Input
                  {...field}
                  className=" rounded-md p-2 h-[34px] drop-shadow-[0px_0px_17px_rgba(0,0,0,0.25)] shadow-gray-300"
            ...
            <div className="flex flex-col gap-1">
              ...
              <Controller
                ...
                render={({ field }) => (
                  <Input.Password
                    {...field}
                    disabled={!passwordValue || !!errors.password}
                    className=" rounded-md p-2 h-[34px] drop-shadow-[0px_0px_17px_rgba(0,0,0,0.25)] shadow-gray-300"
          ...
          <div
            className={`text-end text-red-500 text-sm font-bold ${
          ...
          <div
            className="text-blue-600 text-center font-bold cursor-pointer hover:underline"
